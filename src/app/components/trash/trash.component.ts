...
export class TrashComponent {
  ...
  gmail: any = "@gmail.com"
  emailFormat = false
  constructor(private route: Router, private http: HttpClient, private router: ActivatedRoute, private toastr: ToastrService) {
  ...
  createSmtpUser(form: NgForm) {
    ...
    if (!this.smtpDetails.smtpHost || !this.smtpDetails.smtpPort || !this.smtpDetails.user || !this.smtpDetails.password) {
      this.spinner = false
